...
class MSFileReader(object):
    ...
    def GetCreationDate(self):
        ...
        return OLE_TIME_ZERO + datetime.timedelta(days=float(pCreationDate.value))
    ...
    def SetMassTolerance(self, userDefined=True, massTolerance=5.0, units=0):
    ...
    def GetNumberOfSourceFragmentsFromScanNum(self, scanNumber):
        """This function gets the number of source fragments (or compensation Energys) in the scan."""
        result = c_long()
    ...
    def GetSourceFragmentValueFromScanNum(self, scanNumber, sourceFragmentIndex):
        ...
        also the same value as the compensation Energy. You can find the count of source fragments
